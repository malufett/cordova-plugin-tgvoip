...
import org.parler.tgnet.SerializedData;
...
public class SharedConfig {
    ...
    public static void checkSaveToGalleryFiles() {
        try {
            File telegramPath = new File(Environment.getExternalStorageDirectory(), "Parler");
            File imagePath = new File(telegramPath, "Parler Images");
            imagePath.mkdir();
            File videoPath = new File(telegramPath, "Parler Video");
            videoPath.mkdir();
