...
#include "tgcalls/platform/android/AndroidInterface.h"
#include "tgcalls/platform/android/AndroidContext.h"
...
NetworkType parseNetworkType(jint networkType)
{
    switch (networkType)
    {
    case org_tgvoip_Instance_NET_TYPE_GPRS:
        return NetworkType::Gprs;
    case org_tgvoip_Instance_NET_TYPE_EDGE:
        return NetworkType::Edge;
    case org_tgvoip_Instance_NET_TYPE_3G:
        return NetworkType::ThirdGeneration;
    case org_tgvoip_Instance_NET_TYPE_HSPA:
        return NetworkType::Hspa;
    case org_tgvoip_Instance_NET_TYPE_LTE:
        return NetworkType::Lte;
    case org_tgvoip_Instance_NET_TYPE_WIFI:
        return NetworkType::WiFi;
    case org_tgvoip_Instance_NET_TYPE_ETHERNET:
        return NetworkType::Ethernet;
    case org_tgvoip_Instance_NET_TYPE_OTHER_HIGH_SPEED:
        return NetworkType::OtherHighSpeed;
    case org_tgvoip_Instance_NET_TYPE_OTHER_LOW_SPEED:
        return NetworkType::OtherLowSpeed;
    case org_tgvoip_Instance_NET_TYPE_DIALUP:
        return NetworkType::Dialup;
    case org_tgvoip_Instance_NET_TYPE_OTHER_MOBILE:
...
DataSaving parseDataSaving(JNIEnv *env, jint dataSaving)
{
    switch (dataSaving)
    {
    case org_tgvoip_Instance_DATA_SAVING_NEVER:
        return DataSaving::Never;
    case org_tgvoip_Instance_DATA_SAVING_MOBILE:
        return DataSaving::Mobile;
    case org_tgvoip_Instance_DATA_SAVING_ALWAYS:
        return DataSaving::Always;
    case org_tgvoip_Instance_DATA_SAVING_ROAMING:
...
EndpointType parseEndpointType(JNIEnv *env, jint endpointType)
{
    switch (endpointType)
    {
    case org_tgvoip_Instance_ENDPOINT_TYPE_INET:
        return EndpointType::Inet;
    case org_tgvoip_Instance_ENDPOINT_TYPE_LAN:
        return EndpointType::Lan;
    case org_tgvoip_Instance_ENDPOINT_TYPE_TCP_RELAY:
        return EndpointType::TcpRelay;
    case org_tgvoip_Instance_ENDPOINT_TYPE_UDP_RELAY:
...
jint asJavaState(const State &state)
{
    ...
    {
    case State::WaitInit:
        return org_tgvoip_Instance_STATE_WAIT_INIT;
    case State::WaitInitAck:
        return org_tgvoip_Instance_STATE_WAIT_INIT_ACK;
    case State::Established:
        return org_tgvoip_Instance_STATE_ESTABLISHED;
    case State::Failed:
        return org_tgvoip_Instance_STATE_FAILED;
    case State::Reconnecting:
        return org_tgvoip_Instance_STATE_RECONNECTING;
    }
}
...
extern "C"
{
    ...
    JNIEXPORT jlong JNICALL Java_org_tgvoip_NativeInstance_makeGroupNativeInstance(JNIEnv *env, jclass clazz, jobject instanceObj, jboolean highQuality)
    {
        initWebRTC(env);
    ...
    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_setJoinResponsePayload(JNIEnv *env, jobject obj, jstring ufrag, jstring pwd, jobjectArray fingerprints, jobjectArray candidates)
    {
    ...
    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_removeSsrcs(JNIEnv *env, jobject obj, jintArray ssrcs)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->groupNativeInstance == nullptr)
        {
    ...
    JNIEXPORT jlong JNICALL Java_org_tgvoip_NativeInstance_makeNativeInstance(JNIEnv *env, jclass clazz, jstring version, jobject instanceObj, jobject config, jstring persistentStateFilePath, jobjectArray endpoints, jobject proxyClass, jint networkType, jobject encryptionKey, jobject remoteSink, jlong videoCapturer, jfloat aspectRatio)
    {
        ...
        Descriptor descriptor = {
            .config = Config{.initializationTimeout = configObject.getDoubleField("initializationTimeout"),
    ...
    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_setGlobalServerConfig(JNIEnv *env, jobject obj, jstring serverConfigJson)
    {
        SetLegacyGlobalServerConfig(tgvoip::jni::JavaStringToStdString(env, serverConfigJson));
    }

    JNIEXPORT jstring JNICALL Java_org_tgvoip_NativeInstance_getVersion(JNIEnv *env, jobject obj)
    {
        return env->NewStringUTF(tgvoip::VoIPController::GetVersion());
    }

    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_setBufferSize(JNIEnv *env, jobject obj, jint size)
    {
    ...
    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_setNetworkType(JNIEnv *env, jobject obj, jint networkType)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
    ...
    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_setMuteMicrophone(JNIEnv *env, jobject obj, jboolean muteMicrophone)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance != nullptr)
        {
    ...
    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_setAudioOutputGainControlEnabled(JNIEnv *env, jobject obj, jboolean enabled)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance == nullptr)
        {
    ...
    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_setEchoCancellationStrength(JNIEnv *env, jobject obj, jint strength)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance == nullptr)
        {
    ...
    JNIEXPORT jstring JNICALL Java_org_tgvoip_NativeInstance_getLastError(JNIEnv *env, jobject obj)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance == nullptr)
        {
    ...
    JNIEXPORT jstring JNICALL Java_org_tgvoip_NativeInstance_getDebugInfo(JNIEnv *env, jobject obj)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance == nullptr)
        {
    ...
    JNIEXPORT jlong JNICALL Java_org_tgvoip_NativeInstance_getPreferredRelayId(JNIEnv *env, jobject obj)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance == nullptr)
        {
    ...
    JNIEXPORT jobject JNICALL Java_org_tgvoip_NativeInstance_getTrafficStats(JNIEnv *env, jobject obj)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance == nullptr)
        {
    ...
    JNIEXPORT jbyteArray JNICALL Java_org_tgvoip_NativeInstance_getPersistentState(JNIEnv *env, jobject obj)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance == nullptr)
        {
    ...
    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_stopNative(JNIEnv *env, jobject obj)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance == nullptr)
        {
    ...
    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_stopGroupNative(JNIEnv *env, jobject obj)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->groupNativeInstance == nullptr)
        {
    ...
    JNIEXPORT jlong JNICALL Java_org_tgvoip_NativeInstance_createVideoCapturer(JNIEnv *env, jclass clazz, jobject localSink, jboolean front)
    {
        initWebRTC(env);
    ...
    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_destroyVideoCapturer(JNIEnv *env, jclass clazz, jlong videoCapturer)
    {
        VideoCaptureInterface *capturer = reinterpret_cast<VideoCaptureInterface *>(videoCapturer);
        delete capturer;
    }

    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_switchCameraCapturer(JNIEnv *env, jclass clazz, jlong videoCapturer, jboolean front)
    {
        VideoCaptureInterface *capturer = reinterpret_cast<VideoCaptureInterface *>(videoCapturer);
        capturer->switchToDevice(front ? "front" : "back");
    }

    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_setVideoStateCapturer(JNIEnv *env, jclass clazz, jlong videoCapturer, jint videoState)
    {
        VideoCaptureInterface *capturer = reinterpret_cast<VideoCaptureInterface *>(videoCapturer);
        capturer->setState(static_cast<VideoState>(videoState));
    }

    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_switchCamera(JNIEnv *env, jobject obj, jboolean front)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance == nullptr)
        {
    ...
    JNIEXPORT void Java_org_tgvoip_NativeInstance_setVideoState(JNIEnv *env, jobject obj, jint state)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance == nullptr)
        {
    ...
    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_setupOutgoingVideo(JNIEnv *env, jobject obj, jobject localSink, jboolean front)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance == nullptr)
        {
    ...
    JNIEXPORT void JNICALL Java_org_tgvoip_NativeInstance_onSignalingDataReceive(JNIEnv *env, jobject obj, jbyteArray value)
    {
        InstanceHolder *instance = getInstanceHolder(env, obj);
        if (instance->nativeInstance == nullptr)
        {
